export function Footer() {
  return (
    <footer className="relative flex w-[402px] max-w-full shrink-0 flex-col items-center gap-4 bg-[color:var(--10,white)] px-5 pb-12 pt-5">
      ...
      <p className="relative w-[335px] max-w-full shrink-0 text-center text-[14px] font-medium leading-5 text-[color:var(--400,#b0b0b0)]">
        Made with Figma, Claude, Framer, My skills
        <br aria-hidden="true" />
