...
export function ProjectsSection() {
  return (
    <div className="relative flex w-full shrink-0 flex-col items-start pt-16">
      ...
      <div className="relative flex w-full shrink-0 flex-col items-center justify-center p-5">
        <a
          href="/case/finarum"
      ...
      <div className="relative flex w-full shrink-0 flex-col items-center justify-center px-5 pt-5 pb-5">
        <Link
          href="/case/qrtifact"
          aria-label="Открыть кейс QRtifact"
          className="relative flex w-full max-w-[362px] shrink-0 flex-col items-center justify-center gap-3"
        >
          <div className="relative flex h-[200px] w-[362px] max-w-full shrink-0 flex-col items-start overflow-clip rounded-[26px] bg-[color:var(--50,#f5f5f5)] text-center">
            ...
            <div className="absolute left-1/2 top-2 h-[246px] w-[150px] -translate-x-1/2">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                alt=""
